...
estim_locreg_fun <- function(N = 400, lambda = 300, design = "d1", center = FALSE){
  ...
  ## Save
  if (center) {
    file_name <- paste0("./inst/11_mc_simulate_data/locreg_estimates/dt_locreg_N=", N, "_lambda=", lambda, "_centered_", design, ".RDS")
  } else {
    file_name <- paste0("./inst/11_mc_simulate_data/locreg_estimates/dt_locreg_N=", N, "_lambda=", lambda, "_", design, ".RDS")
  }
