...
## Plot function
gplot <- function(N = 400, lambda = 300, ti = 0.2, param = "Ht"){
  dt_proxy <- readRDS(paste0("./inst/10_mc_simulate_data/data/dt_mc_far_proxy_N=400_lambda=300.RDS"))
  dt_proxy_centered <- readRDS(paste0("./inst/10_mc_simulate_data/data/dt_mc_far_proxy_centered_N=400_lambda=300.RDS"))
